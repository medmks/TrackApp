...
const ColumnDashboard = ({column}) => {
  return (
    <div className="bg-transparent   w-full  h-[500px] max-h-[450px] rounded-md flex flex-col  ">
          ...
          <div className="h-[2px]  mt-5 bg-gradient-to-r from-indigo-500 to-sky-400  " />

          <div className="mt-10">
                    <ProjectBoardCard mission={Missions[1]}/>
          </div>
    </div>
  )
}
